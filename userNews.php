...
<div id="container">
    ...
    <div id="column-right">
        <ul>
            <li> <a href="userNews.php?=<?php echo $iduser;?>">Moje vijesti</a> </li>
            <li> <a href="userSuggestion.php?=<?php echo $iduser;?>">Moji prijedlozi</a> </li>
            <li> <a href="userComment.php?=<?php echo $iduser;?>">Moji komentari</a> </li>
