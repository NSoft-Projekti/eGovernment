    ...
    <div id="column-left">
        <div class="user_post">
            ...
            while ($row = mysql_fetch_assoc($result)) {
                ...
                echo '<p><span class="posted">postavio/la <a class="user_link" href="profileView.php?id='.$iduser.'">'.$_SESSION["SESS_FIRST_NAME"].'</a></span></p>';                echo ' <div class="entry"><p>'.$row["summary"].'</p></div>';
