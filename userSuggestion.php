...
<div id="container">
    ...
    <div id="column-left">
        <div class="user_post">
            ...
            $sql = "SELECT * from post inner join user on post.iduser=user.iduser WHERE POST.idpost_type='3'AND post.iduser=$iduser LIMIT $offset, $rowsperpage";
            ...
            while ($row = mysql_fetch_assoc($result)) {
                ...
                echo '<p><span class="posted">postavio/la <a href="profileView.php?id='.$iduser.' ">'.$name.'</a></span></p>';
    ...
    <div id="column-right">
        <ul>
            <li> <a href="userNews.php?=<?php echo $iduser;?>">Korisničke vijesti</a> </li>
            <li> <a href="userSuggestion.php?=<?php echo $iduser;?>">Korisnički prijedlozi</a> </li>
            <li> <a href="userComment.php?=<?php echo $iduser;?>">Korisnički komentari</a> </li>
